...
public class GitHubJourneyWidgetConfigureActivity extends Activity {
    ...
    private static final String PREFS_NAME = "com.oklab.githubjourney.activities.GitHubJourneyWidget";
    private static final String PREF_PREFIX_KEY = "appwidget_";
    int mAppWidgetId = AppWidgetManager.INVALID_APPWIDGET_ID;
    EditText mAppWidgetText;
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            final Context context = GitHubJourneyWidgetConfigureActivity.this;
    ...
    public GitHubJourneyWidgetConfigureActivity() {
        super();
    }
