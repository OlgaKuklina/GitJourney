...
public class UserProfileAsyncTask extends AsyncTask<Integer, Void, List<GitHubUsersDataEntry>> {
    ...
    protected List<GitHubUsersDataEntry> doInBackground(Integer... args) {
        Integer page = args[0];
        String Uri = context.getString(R.string.url_followers, page);
    ...
    public interface OnProfilesLoadedListener {
        void OnProfilesLoaded(List<GitHubUsersDataEntry> followersDataEntry);
    }
}